...
// pthread_condattr_setpshared()-- Example
...
// and 2 as the standard files; the parent and child I/O is directed to the console. When run in the QShell Interpreter, the
