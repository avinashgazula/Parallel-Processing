...
Use the attatched Makefile to compile the program.
...
main(int argc, char* argv[]) {
  ...
  /* Open the graphics window in position (100,200) on the display */
  MPE_Open_graphics(&graph, MPI_COMM_WORLD, displayname, 100, 200, width, height, 0 );
